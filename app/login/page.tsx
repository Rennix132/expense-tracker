      ...
      <Card className="w-full max-w-md shadow-xl border-none">
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Button type="submit" className="w-full h-11 bg-black hover:bg-gray-800 text-white mt-2" disabled={loading}>
          ...
          <div className="mt-6 text-center text-sm text-gray-500">
            {t.loginNoAccount}{" "}
            <Link href="/register" className="text-black font-medium hover:underline dark:text-white">
              {t.loginRegisterLink}
            </Link>
          </div>
        </CardContent>
